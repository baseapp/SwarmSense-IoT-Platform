...
class FlowerAuthHandler(BaseHandler, OAuth2Mixin):
    ...
    def _OAUTH_AUTHORIZE_URL(self):
        return os.environ['SNMS_FLOWER_AUTHORIZE_URL']

    @property
    def _OAUTH_ACCESS_TOKEN_URL(self):
        return os.environ['SNMS_FLOWER_TOKEN_URL']
    ...
    def get_authenticated_user(self, redirect_uri, code, callback):
        ...
        body = urlencode({
            ...
            'code': code,
            'client_id': os.environ['SNMS_FLOWER_CLIENT_ID'],
            'client_secret': os.environ['SNMS_FLOWER_CLIENT_SECRET'],
    ...
    def _on_auth(self, user):
        ...
        req = HTTPRequest(os.environ['SNMS_FLOWER_USER_URL'],
        ...
        self.set_secure_cookie('user', 'SNMS Admin')

...
from snms.utils.encoding import force_text
...
class EmailMessage:
    ...
    def __init__(self, subject='', body='', from_email=None, to=None, bcc=None,
        ...
        self.from_email = from_email or options.option[const.SETTING_EMAIL_FROM]
    ...
    def get_connection(self, fail_silently=False):
        from snms.core.mail import get_connection
    ...
    def message(self):
        ...
        if 'date' not in header_names:
            ...
            # the stdlib/OS concept of a timezone, however, snms sets the
            # TZ environment variable based on the TIME_ZONE setting which
            # will get picked up by formatdate().
            msg['Date'] = formatdate(localtime=config.EMAIL_USE_LOCAL_TIME)

...
from snms.utils.packaging import get_package_root_path


class SnmsBaseQuery(BaseQuery):
...
def import_all_models(package_name='snms'):
    """Utility that imports all modules in snms/**/models/
